              ...
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                       <p class="card-category">Car Categories </p>
              ...
              <div class="card-footer ">
                ...
                <div class="stats">
                  <i class="fa fa-refresh"></i>
                    <a href="{{ route('admin.categories') }}"> View List </a>
                  {{-- Update Now --}} 
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"> {{ count($cars) }} <p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-footer ">
                ...
                <div class="stats">
                  <i class="fa fa-eye"></i>
                  <a href="{{ route('admin.cars') }}"> View List</a>
            ...
            <div class="card card-stats">
              ...
              <div class="card-footer ">
                ...
                <div class="stats">
                  ...
                  <a href=" {{ route('admin.orders') }} "> View List </a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"> {{ count($contacts) }} <p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-footer ">
                ...
                <div class="stats">
                  <i class="fa fa-eye"> </i>
                  <a href="{{ route('admin.contacts') }}"> View List </a>
